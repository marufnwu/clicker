                                ...
                                <tbody class="bg-white">
                                    ...
                                    @isset($users)
                                        @foreach ($users as $user)
                                            <tr>
                                                <td
                                                    class="px-1 sm:px-3 md:px-6 py-2 md:py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <a href="{{ route('admin.profile', ['user' => $user->id]) }}"
                                                        ...
                                                        <div class=" ml-2 sm:ml-4">
                                                            <div
                                                                class="text-xs sm:text-sm font-medium sm:leading-5 text-gray-900">
                                                                {{ $user->name }}
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <td
                                                    class="px-1 sm:px-3 md:px-6 py-2 md:py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="text-xs sm:text-sm sm:leading-5 text-gray-900">
                                                        {{ $user->email }}</div>
                                                </td>
                                                <td
                                                    class="px-1 sm:px-3 md:px-6 py-3 md:py-6 whitespace-no-wrap border-b border-gray-200">
                                                    <div
                                                        class="text-xs sm:text-sm sm:leading-5 font-semibold  {{ $user->status == \App\Enums\AccountStatus::Active->value ? 'text-green-800 ' : ($user->status == \App\Enums\AccountStatus::Under_Review->value ? 'text-blue-800 ' : 'text-red-800 bg-red-100') }} ">
                                                ...
                                                <td
                                                    class="px-1 sm:px-3 md:px-6 py-2 md:py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="text-xs sm:text-sm sm:leading-5 text-gray-500">
                                                        {{ $user->phone }}</div>
                                                </td>
                                            </tr>
                                        @endforeach
