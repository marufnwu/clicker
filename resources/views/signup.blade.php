                                ...
                                <form method="POST" action="{{ route('submitSignup') }}" class="space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <select name="gender" id="gender"
                                            class=" default-font-1 mt-1 px-2 py-1.5 bg-white block w-full rounded-md border-sky-300 shadow-sm focus:border-sky-300 ring-1 ring-inset ring-gray-300">
                                            <option value="male" class=" font-medium text-gray-700">Male</option>
                                            <option value="female" class=" font-medium text-gray-700">Female</option>
                                            <option value="other" class=" font-medium text-gray-700">Others</option>
                                        </select>
                                        @error('gender')
                                            <div class="pt-1 mb-2 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400"
                                                role="alert">
                                    ...
                                    <div>
                                        ...
                                        <textarea placeholder="Vill, Thana, District" name="area"
                                            class="resize-y px-2 w-full border rounded-md text-gray-900 shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6" value="{{ old('area') ?? '' }}"></textarea>
                                        @error('area')
                                            <div class="pt-1 mb-2 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400"
                                                role="alert">
                                                <span class="font-medium">{{ $message }}</span>
